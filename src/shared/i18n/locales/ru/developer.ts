...
export const developer = {
    ...
    'developer.organizationsTab': 'Организации',
    'organization.email': 'Email',
    'organization.website': 'Сайт',
    'organization.empty': 'Организации ещё не добавлены.',
    'organization.new': 'Новая организация',
    'organization.newTitle': 'Добавить организацию',
    'organization.addSuperAdmin': 'Добавить супер-админа',
    'organization.passwordHint': 'Пароль выбираете вы — передайте его владельцу центра. Больше он нигде не показывается.',
    'organization.daysBeforeDebt': 'Дней до долга',
    'organization.search': 'Поиск по названию организации',
    'plan.code': 'Код',
    'plan.name': 'Название',
    ...
    'subscription.mine': 'Ваш тариф',
    'subscription.daysLeft': 'Осталось дней',
    'subscription.endingWarning': 'Срок подписки заканчивается. Свяжитесь с нами для продления.',
    'subscription.expiredWarning': 'Срок подписки истёк. Свяжитесь с нами, чтобы работа не остановилась.',
