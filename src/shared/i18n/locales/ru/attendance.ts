...
export const attendance: Record<AttendanceKeys, string> = {
    ...
    'attendance.printJournal': 'Печать',
    'attendance.journalTitle': 'Журнал посещаемости',
    'attendance.centerName': 'УЧЕБНЫЙ ЦЕНТР',
    'attendance.groupLabel': 'Группа',
    'attendance.monthLabel': 'Месяц',
    'attendance.teacherSignature': 'Подпись преподавателя',
    'attendance.presentSymbol': '+',
    'attendance.absentSymbol': '−',
    'attendance.excusedSymbol': 'S',
    'attendance.legend': "Обозначения: '+' — был, '−' — не был, 'S' — по уважительной",
}
