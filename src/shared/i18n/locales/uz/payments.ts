...
export const payments = {
    ...
    'invoice.createForGroup': 'Guruh',
    'invoice.createForMonth': 'Shu oy uchun hisob yaratish',
    'invoice.createForGroupHint': 'Hisoblar odatda o‘zi yaratiladi. Bu tugma faqat yaratilmay qolgan holat uchun.',
    'invoice.createForGroupDone': 'Hisoblar yaratildi.',
    'invoice.groupAlreadyCreated': 'Bu guruhga shu oy uchun hisob allaqachon yaratilgan.',
