...
export const developer = {
    ...
    'developer.organizationsTab': 'Tashkilotlar',
    'organization.email': 'Email',
    'organization.website': 'Sayt',
    'organization.empty': 'Hali tashkilot qo‘shilmagan.',
    'organization.new': 'Yangi tashkilot',
    'organization.newTitle': 'Tashkilot qo‘shish',
    'organization.addSuperAdmin': 'Super-admin qo‘shish',
    'organization.passwordHint': 'Parolni o‘zingiz tanlaysiz — uni markaz egasiga yetkazing. Boshqa joyda ko‘rsatilmaydi.',
    'organization.daysBeforeDebt': 'Qarzgacha kun',
    'organization.search': 'Tashkilot nomi bo‘yicha qidirish',
    'plan.code': 'Kod',
    'plan.name': 'Nomi',
    ...
    'subscription.mine': 'Sizning tarifingiz',
    'subscription.daysLeft': 'Qolgan kun',
    'subscription.endingWarning': 'Obuna muddati tugayapti. Uzaytirish uchun bizga murojaat qiling.',
    'subscription.expiredWarning': 'Obuna muddati tugadi. Ish to‘xtab qolmasligi uchun bizga murojaat qiling.',
