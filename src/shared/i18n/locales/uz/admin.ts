...
export const admin = {
    ...
    'admin.initialPasswordHint': 'Parol avtomatik yaratiladi va saqlangandan keyin bir marta ko‘rsatiladi — yozib oling.',
    'admin.filterStatus': 'Status bo’yicha filtr',
    'credentials.eyebrow': "Kirish ma'lumotlari",
    'credentials.title': 'Parolni yozib oling',
    'credentials.warning': 'Bu parol boshqa ko‘rsatilmaydi — u hech qayerda saqlanmaydi. Oynani yopishdan oldin ko‘chirib oling yoki egasiga ayting. Yo‘qolsa, yangisini administrator beradi.',
    'credentials.saved': 'Yozib oldim',
    'lookup.found': 'Bu raqam tizimda ro‘yxatdan o‘tgan. Shu odammi?',
    'lookup.yesSame': 'Ha, shu odam',
    'lookup.notSame': 'Yo‘q, boshqa odam',
    'lookup.locked': 'Bu ma’lumot tizimda saqlangan va bu yerdan o‘zgartirilmaydi.',
    'lookup.rejected': 'Bu raqam boshqa odamga tegishli. Yangi yozuv ochish uchun administratorga murojaat qiling.',
