...
export const attendance: Record<AttendanceKeys, string> = {
    ...
    'attendance.printJournal': 'Print',
    'attendance.journalTitle': 'Attendance Journal',
    'attendance.centerName': 'EDUCATIONAL CENTER',
    'attendance.groupLabel': 'Group',
    'attendance.monthLabel': 'Month',
    'attendance.teacherSignature': "Teacher's signature",
    'attendance.presentSymbol': '+',
    'attendance.absentSymbol': '−',
    'attendance.excusedSymbol': 'S',
    'attendance.legend': "Legend: '+' — present, '−' — absent, 'S' — excused",
}
