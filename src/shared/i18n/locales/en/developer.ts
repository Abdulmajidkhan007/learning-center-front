...
export const developer = {
    ...
    'developer.organizationsTab': 'Organisations',
    'organization.email': 'Email',
    'organization.website': 'Website',
    'organization.empty': 'No organisations yet.',
    'organization.new': 'New organisation',
    'organization.newTitle': 'Add an organisation',
    'organization.addSuperAdmin': 'Add a super-admin',
    'organization.passwordHint': "You choose the password - pass it to the centre's owner. It is not shown anywhere else.",
    'organization.daysBeforeDebt': 'Days before debt',
    'organization.search': 'Search by organisation name',
    'plan.code': 'Code',
    'plan.name': 'Name',
