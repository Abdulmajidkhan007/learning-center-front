...
export function LeadsPage() {
    ...
    function save() {
        const body: LeadCreateDto = { fullName: form.fullName.trim(), phone: form.phone.trim(), source: form.source || undefined, preferredCourse: (form.preferredCourse.trim() || undefined) as LeadCreateDto['preferredCourse'] }
